        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div x-data="{ deleteModalOpen: false, itemToDelete: { id: null, text: '' } }" class="space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Selamat Datang, Auditor!</h2>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Berikut adalah ringkasan aktivitas audit Anda.</p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg">
                        <h3 class="font-semibold text-lg mb-4 text-gray-800 dark:text-gray-200">Dokumen Diaudit per Bulan</h3>
                        <div class="h-64">
                            <canvas id="auditorLineChart"></canvas>
                        </div>
                    </div>
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg">
                        <h3 class="font-semibold text-lg mb-4 text-gray-800 dark:text-gray-200">Status Dokumen Audit</h3>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg mt-8">
                    <h3 class="font-semibold text-lg mb-4 text-gray-800 dark:text-gray-200">Jumlah Indikator per Kriteria</h3>
                    <div class="h-80">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="font-semibold text-xl text-gray-800 dark:text-gray-200">Daftar Indikator Audit</h3>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-normal text-sm text-gray-700 dark:text-gray-300 max-w-xs">{{ $indikator->teks_indikator }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-700 dark:text-gray-300">{{ $indikator->bobot_indikator }}%</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-700 dark:text-gray-300">{{ $indikator->poin_maks_indikator }}</td>
                                ...
                                <tr>
                                    <td colspan="6">
                                        <div class="text-center py-12">
                                            ...
                                            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-200">Tidak Ada Indikator</h3>
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Mulai dengan menambahkan indikator audit baru.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
                ...
                <div x-show="deleteModalOpen" x-cloak class="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <div x-show="deleteModalOpen" x-transition class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100" id="modal-title">Hapus Indikator?</h3>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Anda yakin ingin menghapus indikator "<strong x-text="itemToDelete.text"></strong>"? Tindakan ini tidak dapat dibatalkan.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-gray-50 dark:bg-gray-900 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            ...
                            <button @click="deleteModalOpen = false" type="button" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 dark:border-gray-600 shadow-sm px-4 py-2 bg-white dark:bg-gray-700 text-base font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 sm:mt-0 sm:w-auto sm:text-sm transition-colors">Batal</button>
                        </div>
                    </div>
                </div>
            </div>
