        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            <h3 class="font-medium text-gray-500 dark:text-gray-400">Kriteria</h3>
                            <p class="mt-1 text-lg">{{ $indikator->subkriteria->kriteria->nama_kriteria }}</p>
                        </div>
                        <div>
                            <h3 class="font-medium text-gray-500 dark:text-gray-400">Sub Kriteria</h3>
                            <p class="mt-1 text-lg">{{ $indikator->subkriteria->nama_subkriteria }}</p>
                        </div>
                        <div>
                            <h3 class="font-medium text-gray-500 dark:text-gray-400">Teks Indikator</h3>
                            <p class="mt-1 text-lg">{{ $indikator->teks_indikator }}</p>
                        </div>
                        <div>
                            <h3 class="font-medium text-gray-500 dark:text-gray-400">Bobot</h3>
                            <p class="mt-1 text-lg">{{ $indikator->bobot_indikator }}%</p>
                        </div>
                        <div>
                            <h3 class="font-medium text-gray-500 dark:text-gray-400">Poin Maksimal</h3>
